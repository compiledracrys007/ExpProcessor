...
void Simulator::executeGlobalToLocalMemCopy(GlobalToLocalMemCopyOp *op) {
...
void Simulator::executeLocalToGlobalMemCopy(LocalToGlobalMemCopyOp *op) {
...
void Simulator::executeMatmul(MatmulOp *op) {
  int coreId = op->getCoreNum();
...
void Simulator::simulateInstructions(
